...
believe = "believe in a thing called love"
rhythm = "rhythm of my heart"
chance = "chance we could make it now"

puts "I #{believe}"
puts "Just listen to the #{rhythm}"
puts "There's a #{chance}"
puts "We'll be rocking 'til the sun goes down"
puts "I #{believe}!!"
